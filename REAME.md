...
Назначение: Количество успешно обработанных запросов в секунду
...
2. Latency P95/P99
Назначение: Время обработки для 95%/99% запросов
Как повлиять в Swagger:
...
Назначение: Процент запросов с ошибками клиента/сервера
Как повлиять в Swagger:
...
Runtime & Resources
1. CPU seconds (rate)
Назначение: Загрузка процессора сервисом
Как повлиять в Swagger:
Массовые операции: POST /api/Test/add-100-coins
Ресурсоемкие вычисления
Интерпретация:
Постоянно высокий CPU → оптимизация кода
Пики при нагрузке → норма
2. Working Set (bytes)
Назначение: Память, используемая процессом
Как повлиять в Swagger:
...
Назначение: Число потоков в пуле .NET
Как повлиять в Swagger:
Параллельные запросы из нескольких вкладок
...
6. Process Threads
Назначение: Общее число потоков процесса
Как повлиять в Swagger:
